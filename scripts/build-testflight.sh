...
ARCHIVE_PATH="${ARCHIVE_PATH:-$ROOT/Build/TestFlight/花计2046.xcarchive}"
...
echo ""
echo "TestFlight IPA 已生成：$EXPORT_PATH/花计2046.ipa"
echo "下一步可用 Xcode Organizer 或 Transporter 上传到 App Store Connect。"
